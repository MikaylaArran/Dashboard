/* app.js - FULL FILE (RESTORED - LOCAL JSON)
   - Instability loads from local: data/instability.json
   - Top News loads from local: data/top_news_*.json
   - Restores missing drawer, map, and boot code
*/
